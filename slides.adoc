...
* Within the domain that we are working in, we can not: 
    ** Use network dissimilarity measures to detect abnormalities in term usage over time. 
    ** There are no differences between the usage of terms between subreddits.
